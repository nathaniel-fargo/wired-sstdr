...
% DISPLAY_NETWORK_RESULTS - Combines network diagram and LiveWire results into a single display.
%
%   display_network_results(networks_csv_file, livewire_results_folder, specific_network_ids, output_save_folder)
%
%   Inputs:
%       networks_csv_file       - Path to the CSV file defining networks (e.g., 'networks.csv').
%       livewire_results_folder - Path to the folder containing LiveWire CSV results
%                                 (e.g., 'bnc_network/branch_tests/2025-05-21/LiveWire/Static/CSV/').
%                                 CSV files in this folder should be named like 'T0.csv', 'T1.csv', etc.
%                                 matching the IDs in networks_csv_file.
%       specific_network_ids    - (Optional) Cell array of network IDs to process (e.g., {'T0', 'T1'}).
%                                 If empty or not provided, all networks from networks_csv_file are processed.
%       output_save_folder      - (Optional) Folder to save the combined plots. If empty or not
%                                 provided, plots are displayed but not saved.
%
%   Requires:
%       - draw_network.m (refactored to accept an axes handle)
%       - plot_livewire_csv.m (refactored to accept an axes handle)
%
%   Example Usage:
%       % Process all networks, display plots (don''t save)
%       display_network_results('bnc_network/branch_tests/2025-05-21/networks.csv', ...
%                               'bnc_network/branch_tests/2025-05-21/LiveWire/Static/CSV/');
%
%       % Process specific networks T0 and T4, save to 'CombinedPlots' folder
%       display_network_results('bnc_network/branch_tests/2025-05-21/networks.csv', ...
%                               'bnc_network/branch_tests/2025-05-21/LiveWire/Static/CSV/', ...
%                               {'T0', 'T4'}, 'CombinedPlots/');
%
%   Author: Auto-generated by Gemini
%   Date: 2024-07-30
