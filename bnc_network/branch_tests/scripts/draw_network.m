...
% DRAW_NETWORK  Visualise branch networks and cable lengths.
%   draw_network(networks_csv, network_ids, output_folder, [ax_handle])
%   - networks_csv: path to the networks CSV file (default: branch_tests/2025-05-21/networks.csv)
%   - network_ids: cell array of network IDs to plot (e.g., {'T0','T1'}), or empty for all
%   - output_folder: folder to save plots (optional, if not given, plots are not saved)
%   - ax_handle: optional handle to an axes object to draw on
