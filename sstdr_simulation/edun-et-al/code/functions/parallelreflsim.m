function [X,x] = parallelreflsim(S,Z0,Z1,Zi)
%PARALLELREFLSIM  Simulate the response to a parellel interface impedance
%   [X,x] = PARALLELREFLSIM(S,Z0,Z1,Zi) calculates the reflection  
%   coefficient for a parallel interface impedance Zi in a transmission
...
% 
    ...
    Gamma = (Z1.*Zi - Z0.*Zi - Z0.*Z1 )./(Z1.*Zi + Z0.*Zi + Z0.*Z1);    % Reflection Coefficient
