...
for i = 1:network_config.num_segments
    ...
    try
        ...
        % Link to line_test.mat file for frequency-dependent parameters
        try
            set_param(tl_block, 'WBfile', './line_test.mat');
            fprintf('      ✓ Linked to line_test.mat\n');
        catch ME_mat
            fprintf('      ⚠ Could not link to line_test.mat: %s\n', ME_mat.message);
        end
